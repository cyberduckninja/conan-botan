...
class BotanConan(ConanFile):
    ...
    def _configure_cmd(self):
        ...
        if self.options.without_os_feature:
            build_flags.append('--without-os-feature={}'.format(self.options.without_os_feature))
